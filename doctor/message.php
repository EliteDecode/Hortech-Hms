...
?>
            ...
            <div class="col-md-10 col-lg-10 col-xl-10 "
                ...
                <div class='send_form' id="form_m">
                    ...
                    VALUES (?,?,?,?,?,?,?,?);";
                        ...
                        if ($result) {
                            $query = "UPDATE  `message` SET Reply = 'replied' WHERE Reciever = '$user'
                ...
                <div id="recieved" style='display:none; padding:3%' class="shadow">
                    ...
                    if (mysqli_num_rows($result) < 1) {
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            $output .= "<tr> 
                                        <td style='font-size:12px; font-weight:bolder;'>Admin $who</td>
    ...
    function show(e) {
        ...
        var method = "POST";
        var url = "../admin/ajax/ajax_get_input_title.php";
        var sync = true;
