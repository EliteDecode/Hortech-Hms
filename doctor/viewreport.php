                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 col-xl-4">
                       ...
                       style='font-weight:lighter'>$title</span></h5>
                        ...
                        <h5 style='font-size:15px; margin-bottom:3%; font-weight:bold;'> Report Sent at: <span
                                style='font-weight:lighter'>$dateView</span> </h5>
                        <h5 style='font-size:15px; margin-bottom:3%; font-weight:bold;'>Feedback: <span
                                style='font-weight:lighter'>$feedback</span> </h5>
                        <h5 style='font-size:15px; margin-bottom:3%; font-weight:bold;'>Feedback Sent at: <span
                                style='font-weight:lighter'>$datesent</span> </h5>
                    ...
                    <div class="col-md-4 col-lg-4 col-xl-4">
                        ...
                        <?php
                         if (isset($_POST['send'])) {
                           ...
                           if (empty($feedback)) {
                              $error['feedback'] = 'Add Your Feedback';
                           }
                           ...
                           if (count($error) == 0) {
                            ...
                            $sql = "UPDATE report SET Feedback = ?, FeedbackDate = ? 
                            WHERE Patient = '$user' AND Title = '$title' ";
                           ...
                           $date =date("jS M Y H:i:s"); 
                            ...
                            mysqli_stmt_bind_param($stmt, 'ss', $feedback, $date);
                            ...
                            <div style="top:1%; left:3%; position:absolute; width:70%" id="error">
                            <h6 class="alert alert-success text-dark" >Feedback sent succesfully</h6></div>';
                            
                                }

                         } 
                         if (isset($error['feedback'])) {
                            $er = $error['feedback'];
                            $display = ' <script>
                            function hide(){
                               var error = document.getElementById("error").style.display="none";
                        ...
                        <form action="" class=" salary_form" method="post" id="form_u" style="position:relative; ">
                            ...
                            <!-- <i class="fa fa-close" style="position:absolute; left:90%; color:#17a2b8; cursor:pointer;"
                                id="close_u"></i> -->
                            <h6>Send Feedback To <?php echo $Username?> </h6>

                            <div class="form-group" style="margin-top:-1%">
                                <div class="form-group">
                                    <label for="title" style="font-size:14px; font-weight:bold;"> Title</label>
                                    <input type="text" name="title" value="<?php echo $title?>" class="form-control"
                                        placeholder="Your username..." style="border:2px solid #00c3ff; padding:7% 3%;
                                     font-size:13px; margin-top:-1.5%;font-weight:bold; 
                                     color:#085e79; border-radius:10px; background-color:#fff;" />
                                </div>
                                <label for="username" style="font-size:12px; font-weight:bold; color:#085e79;">
                                    Message</label>
                                <textarea name="feedback" id="" cols="30" value="<?php echo $feedback?>" rows="5"
                                    placeholder="Add Feedback...." class="form-control" style="border:2px solid #00c3ff; padding:4% 3%;
                                     font-size:13px; margin-top:-1.5%;font-weight:bold;
                                      color:#085e79; border-radius:10px; background-color:#fff;"></textarea>
                            </div>
