        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-10 col-xl-10"
                ...
                <?php 
                    ...
                    $sql = "SELECT * FROM report WHERE Doctor = '$user' And Stats = 'Pending' ORDER BY DateReg ASC";
                    ...
                    $output .= "<table class='table table-bordered   text-center' style='z-index:0;margin-top:7%; color:#085e79;'>
                                <tr> 
                    ...
                    if (mysqli_num_rows($result) < 1) {
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            $output .= "<tr> 
                                        ...
                                        <button class='btn btn-primary text-white' style='font-size:12px;
                                        font-weight:bold; ' 
                                        id='$id' onclick='seen(this)' >Checked</button>
                                        </td>"
                                        ;
                        }
                    }
