    ...
    <section class="register container">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-lg-8 col-xl-8">
                <div style=" height:450px; margin-top:2%; margin-left:0%" class="wrap_bg">
            ...
            <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 wrap_form ">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <h4 class="text-center" style="font-size:16px; margin:8% 0%; color:#085e79;">Register as a Doctor
                    </h4>
                    ...
                    <div id="secondBatch" style="display:none">
                        ...
                        <div class="form-group" style="font-size:14px; font-weight:bold;">
                            <label for="passwcvord"> Resume Upload</label>
