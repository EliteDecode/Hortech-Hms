...
<body>
    ...
    <?php
                  ...
                  <li class="nav-item">
                      <a href="#" class="nav-link" style="color: #085e79;"> <i class="fa fa-user"></i> '.$username.' 
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="../admin/logout.php" class="nav-link" style="color: #085e79;"><i class="fa fa-sign-out"></i>Logout</a>
                  </li>
                  </ul>
                  </div>
                  </nav>';
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav" style="justify-content: flex-end">
                        <ul class="navbar-nav" style="margin-right: 10%; margin-top: -0.5%">
                <li class="nav-item">
                    <a href="#" class="nav-link" style="color: #085e79;"> <i class="fa fa-user-md"></i>Dr '.$username.' 
                    </a>
                </li>
                <li class="nav-item">
                    <a href="../doctor/logout.php" class="nav-link" style="color: #085e79;"><i class="fa fa-sign-out"></i>Logout</a>
                </li>
                </ul>
                </div>
                </nav>';
                       ...
                       echo '  <nav class="navbar navbar-expand-lg navbar-light bg-white text-dark">
                       <a class="navbar-brand" href="../home.php">
                           <img src="../images/logo.png" alt="logo" style="width: 45%; height:70px; margin-top:-3%" />
                           <h4>
                               Hortech <span style="color: #00c3ff; font-family: segoe ui">HMS</span>
