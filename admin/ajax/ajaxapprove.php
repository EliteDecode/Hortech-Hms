...
$sql = "UPDATE doctor SET Stats = 'approved' WHERE id = '$response'";
    ...
    //   //
     ...
     $subject = "Application Approval";
      ...
      <div style='background: #fafafa; border-radius: 5px; margin: 10px 0; padding: 20px;'>
          ...
          <p style='font-weight: 100;'>Your Application for a role of a Doctor in Hortech Hospitals, Has been approved. Congratulations!!!!😊</p>
      ...
      <h6 class='alert alert-success text-dark' >Dr  $firstname  $lastname 
        is now a registered Doctor in Hortech Hospitals </h6></div>";
    }
