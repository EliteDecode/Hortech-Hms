<?php
                if (isset($_POST['register'])) {
                   ...
                   $reponse = mysqli_query($conn,$query);
                    ...
                    $sql = "INSERT INTO `patient` (Firstname, Lastname,Username, Pwd,Patientid,Email, Gender,Passport , DateReg )
                    VALUES (?,?,?,?,?,?,?,?,?);";
                  ...
                  mysqli_stmt_bind_param($stmt, 'ssssissss', $firstname, $lastname, $username, $password, $patientid, $email,$gender,$passport,$date);
