        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-10 col-xl-10"
                ...
                <?php 
                 ...
                 $sql = "SELECT * FROM appointments WHERE Stats='delivered' AND Doctor = '$user' ORDER BY DateBooked ASC";
                    ...
                    if (mysqli_num_rows($result) < 1) {
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            $output .= "<tr> 
                                        ...
                                        <td font-weight:bold;'>
                                        <a href='view_appointment.php?view=$id'>
                                        <button class='btn btn-success text-white' style='font-size:12px;
                                        font-weight:bold;'>View</button></a>
                                        </td>
                                        <td ><button class='btn btn-danger' onclick='finish(this)'
                                         id='$id' style='font-size:12px; font-weight:bold;'>Finish</button></td>
