                    ...
                    if (isset($_POST['update_r'])) {
                        ...
                        $tempnameCv = $_FILES["resume"]["tmp_name"];
                        $folderCv = "pdf/" . $resume;
                        ...
                        if (empty($resume)) {
                        $error['resume'] = "Input Doctor's Resume";
                        }

                        if (count($error) == 0) {
                            $sql = "UPDATE  `doctor` SET Cv = ? WHERE Username = '$un'";
                            ...
                            mysqli_stmt_bind_param($stmt, 's', $resume);
                            ...
                            if ($result) {
                                ...
                                <div style=" position:absolute; width:83%; margin:11% 10% 5% 0%" id="error">
                                <h6 class="alert alert-success text-dark" >Resume Updated succesfuly</h6></div>';
                            }
                    ...
                    if (isset($_POST['update_p'])) {
                        ...
                        if (count($error) == 0) {
                            $sql = "UPDATE  `doctor` SET Passport = ? WHERE Username = '$un'";
